...
> **mDNS requires `zeroconf`**, which is an optional dependency. Without it,
> discovery is silently disabled. Install it with the `mdns` extra (e.g.
> `pip install "amplifier-module-hooks-a2a-server[mdns]"`) or `pip install zeroconf`.

> **Running under WSL2 on Windows?** The default NAT networking hides your distro
> from the LAN and blocks mDNS. See **[docs/RUNNING_ON_WSL2.md](docs/RUNNING_ON_WSL2.md)**
> for the mirrored-networking setup that makes LAN discovery and inbound connections work.
